...
class TfBoardLogger:
    ...
    def register(self, name, dtype):
        ...
        self.summaries[name] = tf.summary.scalar(name + '_summary', placeholder) # the return is a summary operation
    ...
    def plot(self, name, value, step):
        ...
        self.writer.add_summary(out, step) # adds a summary buffer to the event file.
